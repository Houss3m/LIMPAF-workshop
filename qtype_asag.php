...
/**
 * Strings for component 'qtype_asag', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage asag
...
$string['pluginname_link'] = 'question/type/asag';
$string['pluginnameadding'] = 'Adding a short answer question';
$string['pluginnameediting'] = 'Editing a Short answer question';
$string['pluginnamesummary'] = 'Automatic short answer grading plugin based on text similarity, Developed by Limpaf lab';
