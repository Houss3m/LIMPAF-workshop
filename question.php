 ...
 * @copyright  LIMPAF lab - Lachemat Houssam.
 */
class qtype_asag_question extends question_graded_by_strategy
    ...
    public static function compare_string_with_wildcard($string, $pattern, $ignorecase) {
        ...
        similar_text($regexp,trim($string),$percentage);
        // return $percentage;
    ...
    public function grade_response(array $response) {
        ...
        if ($answer) {
            ...
            $test = self::get_correct_response() ;
            similar_text( $response['answer'],  $test['answer'], $percentage);
            // $percentage=$percentage/100;
            return array( $percentage/100, question_state::$gradedwrong);
        }
    }
